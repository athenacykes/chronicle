...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get moveNoteToMatterAction => '移动到 Matter...';

  @override
  String get moveNoteToPhaseAction => '移动到阶段...';

  @override
  String get moveNoteToMatterDialogTitle => '将笔记移动到 Matter';

  @override
  String get moveNoteToPhaseDialogTitle => '将笔记移动到阶段';

  @override
  String get moveNoteCurrentMatterLabel => '当前 Matter';

  @override
  String get moveSourceMatterMissingMessage => '无法移动笔记：源 Matter 不可用。';

  @override
  String get movePhaseRequiresSameMatterMessage => '只能在同一 Matter 内移动到其他阶段。';

  @override
  String moveTargetMatterHasNoPhases(Object matter) {
    return '无法移动笔记。\"$matter\" 没有阶段。';
  }
  ...
  @override
  String get editModeLabel => '编辑';

  @override
  String get readModeLabel => '阅读';

  @override
  String get noteMoreActionsTooltip => '更多笔记操作';

  @override
  String get noteTagsUtilityTitle => '标签';

  @override
  String get noteAttachmentsUtilityTitle => '附件';

  @override
  String get noteLinkedNotesUtilityTitle => '关联笔记';
  ...
  @override
  String get syncAdvancedActionsTooltip => '高级同步操作';

  @override
  String get syncRecoverLocalWinsAction => '将本地重新上传到远端';

  @override
  String get syncRecoverRemoteWinsAction => '将远端重新下载到本地';

  @override
  String get syncForceDeletionNextRunAction => '下次同步强制应用删除';

  @override
  String get syncRecoverLocalWinsTitle => '本地优先恢复';

  @override
  String get syncRecoverLocalWinsWarning =>
      '此操作会用本地数据覆盖远端，并可能删除远端中本地不存在的文件。建议先备份。';

  @override
  String get syncRecoverRemoteWinsTitle => '远端优先恢复';

  @override
  String get syncRecoverRemoteWinsWarning =>
      '此操作会用远端数据覆盖本地，并可能删除本地中远端不存在的文件。建议先备份。';

  @override
  String get syncForceDeletionTitle => '强制应用删除';

  @override
  String syncForceDeletionWarning(Object summary) {
    return '这会为下一次同步启用一次性删除保护绕过。$summary\n仅在已完成备份时继续。';
  }

  @override
  String syncForceDeletionSummary(int candidate, int tracked) {
    return '当前阻止计划：$candidate 个删除，跟踪文件共 $tracked 个。';
  }

  @override
  String get syncForceDeletionSummaryUnknown => '当前没有可用的删除数量估算。';

  @override
  String get syncForceDeletionArmedStatus => '已启用强制删除绕过';
  ...
  @override
  String get matterPresetColorsLabel => '预设颜色';

  @override
  String get matterCustomColorAction => '自定义颜色';

  @override
  String get matterUseColorAction => '使用此颜色';

  @override
  String get matterIconPickerLabel => '图标';

  @override
  String get matterIconDescriptionLabel => '说明';

  @override
  String get matterIconFolderLabel => '文件夹';

  @override
  String get matterIconWorkLabel => '工作';

  @override
  String get matterIconGavelLabel => '法务';

  @override
  String get matterIconSchoolLabel => '学习';

  @override
  String get matterIconAccountBalanceLabel => '财务';

  @override
  String get matterIconHomeLabel => '家庭';

  @override
  String get matterIconBuildLabel => '构建';

  @override
  String get matterIconBoltLabel => '高优先';

  @override
  String get matterIconAssignmentLabel => '任务';

  @override
  String get matterIconEventLabel => '日程';

  @override
  String get matterIconCampaignLabel => '活动';

  @override
  String get matterIconLocalHospitalLabel => '医疗';

  @override
  String get matterIconScienceLabel => '科研';

  @override
  String get matterIconTerminalLabel => '终端';
